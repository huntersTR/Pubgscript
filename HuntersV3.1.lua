gg.alert (os.date([[
🛡️Doğrulama Başarılı Bir Şekilde Tamamlandı          

Tarih: %Y/%m/%d                                        Saat: %H:%M:%S]]))

gg.alert("--------------------------------------------------- ▀▄▀▄▀▄ ▄▀▄▀▄▀▀▄▀▄▀▄ ▄▀▄▀▄▀\n  \b\b╔══════════════════════╗           🏆\b\b\b\b\b\b\b\🇹🇷║F E R D İ T E K İ N║🇹🇷 \n\b  \b╚══════════════════════╝ \n▀▄▀▄▀▄ ▄▀▄▀▄▀▀▄▀▄▀▄ ▄▀▄▀▄▀\n--------------------------------------------------")
...
function CLRLOG()
gg.alert(" ℹ️Bu özelliği kullanmak banlanma riskinizi %20 oranında azaltırℹ️ \n\n 📝Kayıt Temizlemeyi her oyun bittiğinde lobide aktif etmelisiniz ")
  ...
  gg.alert("          Oyundan Kalan Tüm Kalıntılar Başarı İle Silindi. Hunter'S Ekibi Olarak Keyifli Oyunlar dileriz")
end

function EKS()
  GR6 = gg.multiChoice({
    "♻️ Çimleri Kaldır",
    "♻️ Çimleri Kaldır(Sanhok)",
    "🔭 Dürbün ×6",
    "🔬 Dürbün ×8",
    "🌃 Siyah Gökyüzü",
    "🎥 Kamera Hilesi x5",
...
function INFONOREC()
gg.alert("(%75 Sekmeme)Lobide,Diğerleri (%50 ve %100 Sekmeme) Oyun içerisinde Aktif Edilecektir")
end
...
gg.getResults(30)
gg.editAll("200", gg.TYPE_FLOAT)
gg.toast("1.Adım Tamamlandı,Bekleyin")
end
...
function NO75()
gg.alert("❗UYARI❗\n Bu özelliği aktif ettikten sonra aimbot kullanamazsınız. \n \n [Oyun Kapanabilir]")
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
...
function RNK()
GR2 = gg.multiChoice({
"⚪BEYAZ RENK(Tüm İşlemciler) ",
"⚫SİYAH RENK(Tüm İşlemciler) ",
"🔥ATEŞ RENGİ ",
"🌕SARI RENK ",
"🔴KIRMIZI RENK ",
"🛑KIRMIZI RENK [HDR] ",
...
function RNK1()
  ...
  gg.getResults(100)
  gg.editAll("9999", gg.TYPE_FLOAT)
  gg.toast("BEYAZ RENK AKTİF EDİLDİ⚪")
end
...
function RNK2()
  ...
  gg.getResults(100)
  gg.editAll("-9999", gg.TYPE_FLOAT)
  gg.toast("SİYAH RENK AKTİF EDİLDİ⚫")
end
...
gg.clearResults()
  ...
  gg.clearResults()
  gg.toast("Yeşil Renk Aktif Edildi💯")
end 
...
function SGOK()
  gg.toast("Siyah Gökyüzü Aktif Ediliyor...")
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
...
function VGG()
gg.alert("NASIL KULLANILIR?\n\n ℹ️Menüdeki (Lobi) ve (Oyun) Kısmı nerede aktif edeceğinizi gösterir,Eğer Menüde (Lobi/Oyun) yazıyorsa Menü Hem Lobide Hemde Oyunda Aktif Edilecek özellikler içeriyordur. \n \n ➡️Lobide Aktif Edilecek Hileler Listesi \n\n 1-Wallhack\n 2-Renkler\n 3-Anten\n 4-Sekmeme %75\n 5-Vip Menü içerisindeki Kayıtları Temizle\n\n 🔊Not\n\n ~Yukarıda Yazılı Olmayan Tüm Hileler Oyun içerisinde Aktif Edilecektir")
  end
...
function EXT()
GR5 = print("•2019")
print("• Doğan Işık&Sadık Erdoğan Tarafından hazırlandı")
print("• Youtube Kanalı : HUNTER'S")
os.exit()
end
